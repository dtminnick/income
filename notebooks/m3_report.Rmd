...
cm_logistic_train <- caret::confusionMatrix(factor(income_train$predicted_class), factor(income_train$income_num))
...
pred_probs_logistic <- predict(model_logistic, newdata = income_test, type = "response")
